...
$c_Lcalculator_TweetLength$.prototype.colorForRemainingCharsCount__Lcalculator_Signal__Lcalculator_Signal = (function(remainingCharsCount) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(remainingCharsCount$1) {
    return (function() {
      if ((remainingCharsCount$1 !== null)) {
        if ((($uI(remainingCharsCount$1.apply__O()) >= 0) && ($uI(remainingCharsCount$1.apply__O()) <= 14))) {
          return "orange"
        }
      };
      if ((remainingCharsCount$1 !== null)) {
        if (($uI(remainingCharsCount$1.apply__O()) < 0)) {
          return "red"
        }
      };
      return "green"
...
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.apply__T2__T2 = (function(x0$1) {
  if ((x0$1 !== null)) {
    ...
    var sExpr = $as_Lcalculator_Signal(x0$1.$$und2$f);
    $m_Lcalculator_Signal$();
    var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer, sExpr$1) {
      return (function() {
        return $m_Lcalculator_Calculator$().eval__Lcalculator_Expr__sci_Map__D($as_Lcalculator_Expr(sExpr$1.apply__O()), arg$outer.namedExpressions$1$f)
      })
    })(this, sExpr));
